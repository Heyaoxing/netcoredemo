...
namespace SpiderWork
{
    ...
    {
        public BaiduSearchSpider() : base("BaiduSearchSpider", new Site()
        {
            EncodingName = "UTF-8",
        ...
        protected override void MyInit(params string[] arguments)
        {
            ...
            DataVerificationAndReport += () =>
            {
                ...
                verifier.AddSqlEqual("采集总量", "SELECT COUNT(*) AS Result from baidu_search WHERE run_id = DATE(); ", 10);
                verifier.Report();
            };
        }
